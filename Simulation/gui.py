...
def run(x_test_in, y_test_in, x_res_in, y_res_in, x_max_in, y_max_in, num_points_in, est_toa_in, act_toa_in, parabolas_in, x_tri_in, y_tri_in):
    # set all necessary global variables
    global x_test, y_test, x_res, y_res, x_mics, y_mics, x_max, y_max, parabolas, num_points, est_toa, act_toa, x_tri, y_tri
    x_test = x_test_in
    y_test = y_test_in
    x_res = x_res_in
    y_res = y_res_in
...
def main():
    ...
    xe, ye, x, y, h1, h2, h3 = triangulation.triangulate(param)
    ...
    run(x_test_in, y_test_in, x_res_in, y_res_in, x_max_in, y_max_in,
